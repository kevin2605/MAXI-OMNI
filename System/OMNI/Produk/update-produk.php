                        ...
                        <div class="col-12">
                                                    ...
                                                    <li class="nav-item"> <a class="nav-link" id="detail-product-tab">
                                                            <div class="nav-rounded">
                                                                <div class="product-icons">
                                                                    <svg class="stroke-icon">
                                                                        <use
                                                                            href="../../../assets/svg/icon-sprite.svg#product-detail">
                                                                        </use>
                                                                    </svg>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li class="nav-item"> <a class="nav-link" id="gallery-product-tab">
                                                            <div class="nav-rounded">
                                                                <div class="product-icons">
                                                                    <svg class="stroke-icon">
                                                                        <use
                                                                            href="../../../assets/svg/icon-sprite.svg#product-gallery">
                                                                        </use>
                                                                    </svg>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li class="nav-item"> <a class="nav-link" id="category-product-tab">
                                                            <div class="nav-rounded">
                                                                <div class="product-icons">
                                                                    <svg class="stroke-icon">
                                                                        <use
                                                                            href="../../../assets/svg/icon-sprite.svg#product-category">
                                                                        </use>
                                                                    </svg>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li class="nav-item"><a class="nav-link" id="pricings-tab">
                                                            <div class="nav-rounded">
                                                                <div class="product-icons">
                                                                    <svg class="stroke-icon">
                                                                        <use
                                                                            href="../../../assets/svg/icon-sprite.svg#pricing">
                                                                        </use>
                                                                    </svg>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li class="nav-item"><a class="nav-link" id="advance-product-tab">
                                                            <div class="nav-rounded">
                                                                <div class="product-icons">
                                                                    <svg class="stroke-icon">
                                                                        <use
                                                                            href="../../../assets/svg/icon-sprite.svg#advance">
                                                                        </use>
                                                                    </svg>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="sidebar-body">
                                                    <form class="row g-2"
                                                        action="../RequestAPI/tokopedia-create-product.php"
                                                        method="POST">



                                                        <!-- Nama Produk -->
                                                        <label class="form-label col-12 m-0" for="productTitle1">Nama
                                                            Produk <span class="txt-danger">*</span></label>
                                                        <div class="col-12 custom-input">
                                                            <input class="form-control" id="productTitle1" name="name"
                                                                type="text" required>
                                                        </div>

                                                        <label class="form-label col-12 m-0"
                                                            for="productTitle1">Deskripsi Produk <span
                                                                class="txt-danger">*</span></label>
                                                        <div class="col-12 custom-input">
                                                            <textarea class="form-control" id="productTitle1"
                                                                name="description" rows="4" required></textarea>
                                                        </div>

                                                        <!-- Deskripsi Produk (Rich Text Editor) -->
                                                            ...
                                                            <div class="card-body">
                                                                <div class="sidebar-body">
                                                                    <div class="product-upload">
                                                                        <p>Product Image</p>
                                                                        <div class="dropzone dropzone-light"
                                                                            id="multiFileUploadA" action="/upload.php">
                                                                            <div class="dz-message needsclick">
                                                                                <svg>
                                                                                    <use
                                                                                        href="../assets/svg/icon-sprite.svg#file-upload">
                                                                                    </use>
                                                                                </svg>
                                                                                <h6>Drag your image here, or <a
                                                                                        class="txt-primary"
                                                                                        href="#!">browse</a></h6>
                                                                                <span class="note needsclick">SVG, PNG,
                                                                                    JPG or GIF</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="product-upload">
                                                                        <p>Product Gallery</p>
                                                                        <div class="dropzone dropzone-light"
                                                                            id="multiFileUploadB" action="/upload.php">
                                                                            <div class="dz-message needsclick">
                                                                                <svg>
                                                                                    <use
                                                                                        href="../assets/svg/icon-sprite.svg#file-upload1">
                                                                                    </use>
                                                                                </svg>
                                                                                <h6>Drag files here</h6>
                                                                                <span class="note needsclick">Add
                                                                                    Product Gallery Images</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        /**
                                                         * Fungsi untuk menghasilkan opsi dropdown berjenjang
                                                         * @param array $categories - Array kategori dari API
                                                         * @return string - HTML untuk opsi dropdown
                                                         */
                                                        function generateCategoryOptions($categories)
                                                        {
                                                            ...
                                                            foreach ($categories as $category) {
                                                                ...
                                                                // Jika kategori memiliki subkategori (child)
                                                                if (!empty($category['child'])) {
                                                                    foreach ($category['child'] as $subcategory) {
                                                                        // Tambahkan subkategori
                                                                        $html .= "<option value='{$subcategory['id']}'>{$subcategory['name']}</option>";

                                                                        // Jika subkategori memiliki child (sub-subkategori)
                                                                    ...
                                                                    <div class="row g-3 custom-input">
                                                                        <div class="col-sm-4">
                                                                            <label class="form-label"
                                                                                for="initialCost">Initial cost <span
                                                                                    class="txt-danger">*</span></label>
                                                                            <input class="form-control" id="initialCost"
                                                                                name="initial_cost" type="number"
                                                                                required>
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <label class="form-label"
                                                                                for="sellingPrice">Selling price <span
                                                                                    class="txt-danger">*</span></label>
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            ...
                                                                            <input class="form-control" id="usetax"
                                                                                name="usetax" type="text" value="-"
                                                                                readonly>
                                                                        </div>
                                                                    ...
                                                                    <div class="row g-lg-4 g-3" id="input-container">
                                                                        <div class="col-sm-5">
                                                                            <div class="row g-2">
                                                                                ...
                                                                                <label class="form-label col-12 m-0"
                                                                                    for="productID1">SKU</label>
                                                                                <div class="col-12 custom-input">
                                                                                    <input class="form-control"
                                                                                        id="productID1" name="sku"
                                                                                        type="text" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                            ...
                            `;
                                                                    ...
                                                                    <ul class="checkbox-wrapper">
                                                                        <li>
                                                                            <input
                                                                                ...
                                                                                id="checkbox-icon" name="platform[]"
                                                                                type="checkbox" value="Tokopedia">
                                                                        ...
                                                                        <li>
                                                                            <input
                                                                                class="form-check-input checkbox-shadow"
                                                                                id="checkbox-icon1" name="platform[]"
                                                                                type="checkbox" value="Shopee" disabled>
                                                                            <label class="form-check-label"
                                                                                for="checkbox-icon1"><i
                                                                                    class="fa fa-user"></i><span>Shopee</span></label>
                                                                        </li>
                                                                        <li>
                                                                            <input
                                                                                class="form-check-input checkbox-shadow"
                                                                                id="checkbox-icon2" name="platform[]"
                                                                                type="checkbox" value="Tiktok" disabled>
                                                                            <label class="form-check-label"
                                                        ...
                                                        <div class="card-footer">
                                                            ...
                                                            <button class="btn btn-primary m-r-15"
