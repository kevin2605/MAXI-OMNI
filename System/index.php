...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-5"><img class="bg-img-cover bg-center" src="../assets/images/login/3.1.jpg" width="100%"
          alt="looginpage"></div>
      <div class="col-xl-7 p-0">
        <div class="login-card login-dark">
          <div>
            <div><a class="logo text-start" href="index.php"><img class="img-fluid for-light"
                  src="../assets/images/logo-icon.png" width="150px"><img class="img-fluid for-dark"
                  src="../assets/images/logo-icon.png" width="150px"></a></div>
            <div class="login-main">
              <form class="theme-form" action="login.php" method="POST">
                ...
                <h6 class="text-muted mt-3 or">Contact admin to register</h6>
            </div>
          </div>
        </div>
      </div>
