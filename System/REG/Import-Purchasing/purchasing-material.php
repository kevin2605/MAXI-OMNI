                                                            ...
                                                            <table class="display" id="basic-12">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    while ($rowPO = mysqli_fetch_array($resultSO)) {
                                                                        ...
                                                                        <ul>';
                                                                        if ($can_update) {
                                                                            echo '<button onclick="viewIPO(this)" type="button" class="light-card border-primary border b-r-10" value="' . $rowPO["PurchaseOrderID"] . '" style="margin-right: 5px;"><i class="fa fa-eye txt-primary"></i></button>';
                                                                        }
                                                                        echo '<button onclick="editPO(this)" type="button" class="light-card border-warning border b-r-10" value="' . $rowPO["PurchaseOrderID"] . '" style="margin-right: 5px;"><i class="fa fa-pencil-square-o txt-warning"></i></button>';
                                                                        if ($can_print && $rowPO["ApprovalBy"] != NULL) {
                                                                            echo '<button onclick="printIPO(this)" type="button" class="light-card border-info border b-r-10" value="' . $rowPO["PurchaseOrderID"] . '" style="margin-right: 5px;"><i class="fa fa-print txt-info"></i></button>';
                                                                        }
                                                                        echo '</ul>
                                                                            </td>
                                                                        </tr>';
                                                          ...
                                                          WHERE po.Finish=1
                                                                AND po.CategoryCD = 'BB'";
                                                                    ...
                                                                    while ($rowPO = mysqli_fetch_array($resultSO)) {
                                                                        ...
                                                                        echo '<td> 
                                                                                <ul> 
                                                                                    <button onclick="viewIPO(this)" type="button" class="light-card border-primary border b-r-10" value="' . $rowPO["PurchaseOrderID"] . '"><i class="fa fa-eye txt-primary"></i></button>
                                                                                </ul>
                                                                                </td>
                                                                            </tr>
                                                                        ';
