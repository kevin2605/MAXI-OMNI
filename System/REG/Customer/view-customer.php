                ...
                <div class="card-body">
                  ...
                  <form class="row g-3">
                    <div class="col-12">
                      ...
                      <input class="form-control" id="namapel" name="namapel" type="text" placeholder="-"
                        value="<?php echo $customer["CustName"]; ?>" readonly>
                    </div>
                    <div class="col-12">
                      <label class="form-label" for="namacom">Nama Perusahaan</label>
                      <input class="form-control" id="namacom" name="namacom" type="text"
                        value="<?php echo $customer["CompanyName"]; ?>" placeholder="-" readonly>
                    </div>
                    <hr>
                    <ul class="simple-wrapper nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item"><a class="nav-link active txt-primary" id="home-tab" data-bs-toggle="tab"
                          href="#informasi" role="tab" aria-controls="home" aria-selected="true">Informasi</a></li>
                      <li class="nav-item"><a class="nav-link txt-primary" id="profile-tabs" data-bs-toggle="tab"
                          href="#pajak" role="tab" aria-controls="profile" aria-selected="false">Pajak</a></li>
                    </ul>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-6">
                            ...
                            <textarea class="form-control" id="alamatkirim" name="alamatkirim" rows="3"
                              readonly><?php echo $customer["ShipmentAddress"]; ?></textarea>
                          </div>
                          <div class="col-6">
                            <label class="col-sm-12 form-label" for="kota">Kota</label>
                            <input class="form-control" id="kota" name="kota" list="kotaOptions" placeholder="Kota"
                              value="<?php echo $customer["CityName"]; ?>" readonly>
                          </div>
                          <div class="col-3">
                            <label class="form-label" for="nohp1">No. HP 1<span style="color:red;">*</span></label>
                            <input class="form-control" id="nohp1" name="nohp1" type="text" minlength="10"
                              maxlength="15" placeholder="081xxxxxxx" value="<?php echo $customer["PhoneNumOne"]; ?>"
                              readonly>
                          </div>
                          <div class="col-3">
                            <label class="form-label" for="nohp2">No. HP 2</label>
                            <input class="form-control" id="nohp2" name="nohp2" type="text" minlength="10"
                              maxlength="15" placeholder="081xxxxxxx" value="<?php echo $customer["PhoneNumTwo"]; ?>"
                              readonly>
                          </div>
                          <div class="col-6">
                            <label class="form-label" for="email">Email</label>
                            <input class="form-control" id="email" name="email" type="email"
                              placeholder="example@gmail.com" value="<?php echo $customer["Email"]; ?>" readonly>
                          </div>
                          <div class="col-6">
                            ...
                            <input class="form-control" id="pricelist" name="pricelist" list="plOptions"
                              value="<?php echo $customer["PriceListCD"] . " - " . $customer["PriceListName"]; ?>" readonly>
                          </div>
                          <div class="col-6">
                            ...
                            <div class="card-wrapper border rounded-3 checkbox-checked">
                              ...
                              <div class="radio-form">
                                <div class="form-check">
                                  <input class="form-check-input" id="flexRadioDefault3" type="radio" value="1" <?php if ($customer["Status"] == 1) {
                                    echo "checked";
                                  } ?> name="customerStatus" disabled>
                                  <label class="form-check-label" for="flexRadioDefault3">Active</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" id="flexRadioDefault4" type="radio" value="0" <?php if ($customer["Status"] == 0) {
                                    echo "checked";
                                  } ?> name="customerStatus" disabled>
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-6">
                            ...
                            <div class="col-12">
                              <label class="form-label" for="nomorNPWP">No. NPWP<span
                                  style="color:red;">*</span></label>
                              <input class="form-control" id="nomorNPWP" name="nomorNPWP" type="text" placeholder="-"
                                value="<?php if ($customer["NPWPNum"] != "-") {
                                  echo $customer["NPWPNum"];
                                } else {
                                  echo "-";
                                } ?>"
                                readonly>
                            ...
                            <div class="col-12">
                              <label class="form-label" for="namaNPWP">Nama NPWP<span
                                  style="color:red;">*</span></label>
                              <input class="form-control" id="namaNPWP" name="namaNPWP" type="text" placeholder="-"
                                value="<?php if ($customer["NPWPName"] != "-") {
                                  echo $customer["NPWPName"];
                                } else {
                                  echo "-";
                                } ?>"
                                readonly>
                            ...
                            <div class="col-12">
                              ...
                              <textarea class="form-control" id="alamatNPWP" name="alamatNPWP" rows="3"
                                readonly><?php if ($customer["NPWPAddress"] != "-") {
                                  echo $customer["NPWPAddress"];
                                } else {
                                  echo "-";
                                } ?></textarea>
                            </div>
                          ...
                          <div class="col-6">
                            ...
                            <div class="col-12">
                              ...
                              <input class="form-control" id="namaktp" name="namaktp" type="text" placeholder="-"
                                value="<?php if ($customer["KTPName"] != "-") {
                                  echo $customer["KTPName"];
                                } else {
                                  echo "-";
                                } ?>"
                                readonly>
                            ...
                            <div class="col-12">
                              ...
                              <textarea class="form-control" id="alamatktp" name="alamatktp" rows="3"
                                readonly><?php if ($customer["KTPAddress"] != "-") {
                                  echo $customer["KTPAddress"];
                                } else {
                                  echo "-";
                                } ?></textarea>
                            </div>
                    ...
                    <div class="col-12">
                      ...
                      <button class="btn btn-info" type="button" onclick="editCustomer(this)" value="<?php echo $_GET["id"] ?>">Edit</button>
                    </div>
                  </form>
                </div>
              </div>
