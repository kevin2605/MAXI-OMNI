...
<head>
  ...
  $query = "SELECT tSaldoAwal FROM useraccesslevel WHERE UserID = '$userID'";
  $result = mysqli_query($conn, $query);
  $row = mysqli_fetch_assoc($result);

  $hasCRUDAccess = strpos($row['tSaldoAwal'], 'C') !== false || // Create
    strpos($row['tSaldoAwal'], 'R') !== false || // Read
    strpos($row['tSaldoAwal'], 'U') !== false || // Update
    strpos($row['tSaldoAwal'], 'D') !== false;  // Delete
  ...
  <script>
      ...
      <tr id="row${i}">
        <td style="width:30%">
          ...
          <datalist id="prodOptions">
            <?php
            $queryp = "SELECT * FROM product WHERE Status=1";
        ...
        <td style="width:15%">
          <input type="text" class="form-control" name="flowin[]" placeholder="0" required>
        </td>
        <td style="width:10%">
    ...
    `);
      ...
      $.ajax({
        type: "POST",
        url: "../Process/getProductUnit.php",
        data: { prodcd: x.value },
              ...
              <div class="row">
                ...
                <div class="col-sm-6 pe-0">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Saldo Awal</li>
                  </ol>
                </div>
              </div>
            </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-body">
                          ...
                          <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="myExtraLargeModal">Form Saldo Awal</h4>
                                <button class="btn-close py-0" type="button" data-bs-dismiss="modal"
                                  aria-label="Close"></button>
                              </div>
                              <div class="modal-body dark-modal">
                                <div class="card-body custom-input">
                                  <form class="row g-3" action="../Process/createStartBalance.php" method="POST">
                                    <div class="col-4">
                                    ...
                                    <div class="col-4">
                                      ...
                                      <input class="form-control" id="creator" name="creator" type="text"
                                        value="<?php echo $_COOKIE["UserID"] . ' - ' . $_COOKIE["Name"] ?>" readonly>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <tr id="row1">
                                          <td style="width:30%">
                                            <input type="text" class="form-control prodlist" name="products[]"
                                              list="prodOptions" onChange="appendProductTable(this)" required>
                                            <datalist id="prodOptions">
                                              <?php
                                              $queryp = "SELECT * FROM product WHERE Status=1";
                                              $resultp = mysqli_query($conn, $queryp);
                                          ...
                                          <td style="width:15%">
                                            <input type="text" class="form-control" name="flowin[]" placeholder="0"
                                              required>
                                          </td>
                                          <td style="width:10%">
                                            <input type="text" class="form-control" name="units[]" readonly>
                        ...
                        <hr>
                        <h3>Daftar Mutasi Saldo Awal</h3>
                              ...
                              while ($rowM = mysqli_fetch_array($resultM)) {
                                echo '<tr>
                                        ...
                                        <td> 
                                          <ul class="action"> ';
                                  if ($can_update) {
                                    echo '<button onclick="viewMut(this)" type="button" class="light-card border-primary border b-r-10" value="' . $rowM["MutationID"] . '"><i class="fa fa-eye txt-primary"></i></button>';
                                  }
                                  echo ' 
                                          </ul>
                                        </td>
