...
<head>
    ...
    $query = "SELECT mutasibtm FROM useraccesslevel WHERE UserID = '$userID'";
    $result = mysqli_query($conn, $query);
    $row = mysqli_fetch_assoc($result);

    $hasCRUDAccess = strpos($row['mutasibtm'], 'C') !== false || // Create
        strpos($row['mutasibtm'], 'R') !== false || // Read
        strpos($row['mutasibtm'], 'U') !== false || // Update
        strpos($row['mutasibtm'], 'D') !== false;  // Delete
        ...
        <tr id="row${i}">
            <td style="width:30%">
                ...
                <datalist id="prodOptions">
                    <?php
                    $queryp = "SELECT * FROM material WHERE Status=1 AND MaterialCD LIKE '%BTM%'";
                    $resultp = mysqli_query($conn, $queryp);
                    while ($rowp = mysqli_fetch_array($resultp)) {
                        echo '<option value="' . $rowp["MaterialName"] . '"> </option>';
                    }
                    ?>
                </datalist>
            </td>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                $canUpdate = false;
                                                if (!empty($userID)) {
                                                    $query_access = "SELECT mutasibtm FROM useraccesslevel WHERE UserID = '$userID'";
                                                    $result_access = mysqli_query($conn, $query_access);
                                                    if ($result_access) {
                                                        $row_access = mysqli_fetch_assoc($result_access);
                                                        $access_level = $row_access['mutasibtm'];
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body dark-modal">
                                                                <div class="card-body custom-input">
                                                                    <form class="row g-3"
                                                                        action="../Process/createmutationbtm.php"
                                                                        method="POST">
                                                                        <div class="col-4">
                                                                                ...
                                                                                <tr id="row1">
                                                                                    <td style="width:30%">
                                                                                        ...
                                                                                        <datalist id="prodOptions">
                                                                                            ...
                                                                                            $resultp = mysqli_query($conn, $queryp);
                                                                                            while ($rowp = mysqli_fetch_array($resultp)) {
                                                                                                echo '<option value="' . $rowp["MaterialName"] . '">' . $rowp["MaterialName"] . '</option>';
                                                                                            }
                                                                                            ?>
                                                                                        </datalist>
                                                                                    </td>
                                                    ...
                                                    <table class="display" id="basic-12">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            while ($rowM = mysqli_fetch_array($resultM)) {
                                                                ...
                                                                <td> 
                                                                    <ul class="action"> 
                                                                        <button onclick="viewMut(this)" type="button" class="light-card border-primary border b-r-10" value="' . $rowM["MutationID"] . '"><i class="fa fa-eye txt-primary"></i></button>
                                                                    </ul>
                                                                </td>
                                                            </tr>';
                                                            }
