...
<head>
  ...
  $query = "SELECT payofdebit FROM useraccesslevel WHERE UserID = '$userID'";
  $result = mysqli_query($conn, $query);
  $row = mysqli_fetch_assoc($result);

  $hasCRUDAccess = strpos($row['payofdebit'], 'C') !== false || // Create
    strpos($row['payofdebit'], 'R') !== false || // Read
    strpos($row['payofdebit'], 'U') !== false || // Update
    strpos($row['payofdebit'], 'D') !== false;  // Delete
        ...
        success: function (result) {
          ...
          $.each(res, function (index, value) {
            var row = "<tr>" +
              ...
              "<td>" + numeral(value.TotalAmount).format("0,0") + "</td>" +
          ...
          document.getElementById("totalCredit").innerHTML = "Rp " + numeral(totalDebt).format("0,0");
        }
      });
    }
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            if (!empty($userID)) {
                              $query_access = "SELECT payofdebit FROM useraccesslevel WHERE UserID = '$userID'";
                              $result_access = mysqli_query($conn, $query_access);
                              if ($result_access) {
                                $row_access = mysqli_fetch_assoc($result_access);
                                $access_level = $row_access['payofdebit'];
                                      ...
                                      <form class="row g-3" action="../Process/createDebtPayment.php" method="POST">
                                        <div class="row">
                                          <div class="col-3">
                                            ...
                                            <!--
                                                                  <div class="mb-3 row">
                                                                      <label class="col-sm-3">Kode Akun<span style="color:red;">*</span></label>
                                                                      <div class="col-sm-9">
