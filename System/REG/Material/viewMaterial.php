                        ...
                        <div class="card-body custom-input">
                            ...
                            <form class="row g-3" action="../Process/editMaterial.php" method="POST">
                                <div class="col-2"> 
                                    ...
                                    <input class="form-control" id="urutanreport" name="urutanreport" type="text" placeholder="1" value="<?php echo $material["Sequence"]; ?>" readonly>
                                </div>
                                <div class="col-4"> 
                                ...
                                <div class="col-6">
                                    ...
                                    <input class="form-control" id="namabahan" name="namabahan" type="text" placeholder="barang contoh" value="<?php echo $material["MaterialName"]; ?>" readonly>
                                </div>
                                <div class="col-6"> 
                                    <label class="col-sm-12 col-form-label" for="satuanpertama">Satuan Pertama<span style="color:red;">*</span></label>
                                    <input class="form-control" id="satuanpertama" list="satuanOptions" name="satuanpertama" placeholder="Satuan" value="<?php echo $material["UnitCD_1"]; ?>" readonly>
                                ...
                                <div class="col-6"> 
                                    ...
                                    <input class="form-control" id="satuankedua" list="satuanOptions" name="satuankedua" placeholder="Satuan" value="<?php echo $material["UnitCD_2"]; ?>" readonly>
                                    <datalist id="satuanOptions">
                                        <?php
                                            $query = "SELECT UnitCD,UnitName FROM unit WHERE Status='1'";
                                            $result = mysqli_query($conn,$query);
                                ...
                                <div class="col-3"> 
                                    ...
                                    <input class="form-control" id="kategori" name="kategori" list="kategoriOptions" placeholder="Kategori" value="<?php echo $material["CategoryCD"]; ?>" readonly>
                                ...
                                <div class="col-3"> 
                                    ...
                                    <input class="form-control" id="groupbarang" name="group" list="groupOptions" placeholder="Group" value="<?php echo $material["GroupCD"]; ?>" readonly>
                                ...
                                <div class="col-3"> 
                                    ...
                                    <input class="form-control" id="gudang" name="gudang" list="gudangOptions" placeholder="Gudang" value="<?php echo $material["WarehCD"]; ?>" readonly>
                                ...
                                <div class="col-3">
                                    ...
                                    <input class="form-control" id="buyprice" name="buyprice" type="text" placeholder="0" value="Rp <?php echo number_format($material["BuyPrice"],2,'.',','); ?>" readonly>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-6">
                                    <label class="form-label" for="keterangan2">Keterangan 2</label>
                                    <input class="form-control" id="keterangan2" name="keterangan2" type="text" placeholder="..." value="<?php echo $material["Desc_2"]; ?>" readonly>
                                </div>
                                <div class="col-6"></div>
                                <div class="col-6">
                                    <label class="form-label" for="keterangan3">Keterangan 3</label>
                                    <input class="form-control" id="keterangan3" name="keterangan3" type="text" placeholder="..." value="<?php echo $material["Desc_3"]; ?>" readonly>
                                </div>
                                <div class="col-6"></div>
                                <hr>
                                <div class="col-sm-4">
                                    ...
                                    <input class="checkbox_animated" id="chk-jual" name="rulesJual" value="1" type="checkbox" <?php if($material["Sales"]==1){echo "checked";} ?> disabled>Jual
                                    <label class="d-block" for="chk-beli"></label>
                                    <input class="checkbox_animated" id="chk-beli" name="rulesBeli" value="1" type="checkbox" <?php if($material["Purchase"]==1){echo "checked";} ?> disabled>Beli
                                    <label class="d-block" for="chk-produksi"></label>
                                    <input class="checkbox_animated" id="chk-produksi" name="rulesProduksi" value="1" type="checkbox" <?php if($material["Production"]==1){echo "checked";} ?> disabled>Produksi
                                    <label class="d-block" for="chk-transaksi"></label>
                                    <input class="checkbox_animated" id="chk-transaksi" name="rulesTransaksi" value="1" type="checkbox" <?php if($material["Transaction"]==1){echo "checked";} ?> disabled>Transaksi
                                    </div>
                                </div>
                                <div class="col-4"> 
                                    <div class="card-wrapper border rounded-3 checkbox-checked">
                                        ...
                                        <div class="radio-form">
                                            ...
                                            <input class="form-check-input" id="flexRadioDefault3" type="radio" name="produkStatus" value="1" <?php if($material["Status"]==1){echo "checked";} ?> disabled>
                                            <label class="form-check-label" for="flexRadioDefault3">Active</label>
                                            </div>
                                            <div class="form-check">
                                            <input class="form-check-input" id="flexRadioDefault4" type="radio" name="produkStatus" value="0" <?php if($material["Status"]==0){echo "checked";} ?> disabled>
