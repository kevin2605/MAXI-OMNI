...
<head>
  ...
  <script>
    window.onload = function () {
      ...
      var material = url.searchParams.get("matcd");
      showProduct(material);
    };
    function showProduct(x) {
      ...
      if (x != "") {
        ...
        detail = true;
        xmlhttp.open("GET", "../Process/getMatDetail.php?material=" + x, true);
        xmlhttp.send();
      } else if (x == "") {
        alert("Produk kosong!");
        return;
      ...
      if (detail == true) {
        ...
        xmlhttp.open("GET", "../Process/getMatFlowHist.php?material=" + x, true);
        xmlhttp.send();
      }
    }
  </script>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  ...
                  ?>
                  <div class="row">
                    <div class="col-md-4" id="prodDetail">
