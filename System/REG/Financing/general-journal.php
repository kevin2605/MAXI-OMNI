...
<head>
  ...
  $query = "SELECT genjournal FROM useraccesslevel WHERE UserID = '$userID'";
  $result = mysqli_query($conn, $query);
  $row = mysqli_fetch_assoc($result);

  $hasCRUDAccess = strpos($row['genjournal'], 'C') !== false || // Create
    strpos($row['genjournal'], 'R') !== false || // Read
    strpos($row['genjournal'], 'U') !== false || // Update
    strpos($row['genjournal'], 'D') !== false;  // Delete
  ...
  <script>
    ...
    function appendTable(x) {
      ...
      $('#data #datalist').append(`
                <tr id="row${i}">
                    ...
                    <td style="width: 15%;">
                        <input type="number" class="form-control digits debit" name="debit[]" oninput="disableOtherInput(this)" placeholder="0">
                    </td>
                    <td style="width: 15%;">
                        <input type="number" class="form-control digits credit" name="credit[]" oninput="disableOtherInput(this)" placeholder="0">
                    </td>
                    <td>
    ...
    function view(x) {
      document.location = "view-general-journal.php?id=" + x.value;
    }
  </script>
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            if (!empty($userID)) {
                              $query_access = "SELECT genjournal FROM useraccesslevel WHERE UserID = '$userID'";
                              $result_access = mysqli_query($conn, $query_access);
                              if ($result_access) {
                                $row_access = mysqli_fetch_assoc($result_access);
                                $access_level = $row_access['genjournal'];
                            ...
                            ?>
                            <button class="btn btn-outline-primary" type="button" <?php echo $canCreate ? 'data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg"' : 'disabled'; ?>><i
                                class="fa fa-plus-circle"></i> New</button>
                            <div class="modal fade modal-jurnal-umum" tabindex="-1" role="dialog"
                              aria-labelledby="myExtraLargeModal" aria-hidden="true">
                              <div class="modal-dialog modal-fullscreen">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h4 class="modal-title" id="myExtraLargeModal">Form Jurnal Umum</h4>
                                    <button class="btn-close py-0" type="button" data-bs-dismiss="modal"
                                      aria-label="Close"></button>
                                  </div>
                                  <div class="modal-body dark-modal">
                                    <div class="card-body custom-input">
                                      <form class="row g-3" action="../Process/createGeneralJournal.php" method="POST">
                                        <div class="row">
                                          <div class="col-12">
                                            <div class="mb-3 row">
                                                ...
                                                <tr id="row1">
                                                  ...
                                                  <td style="width: 15%;">
                                                    <input type="number" class="form-control digits debit"
                                                      name="debit[]" oninput="disableOtherInput(this)" placeholder="0">
                                                  </td>
                                                  <td style="width: 15%;">
                                                    <input type="number" class="form-control digits credit"
                                                      name="credit[]" oninput="disableOtherInput(this)" placeholder="0">
                                                  </td>
                                                  <td style="width: 10%;">
                                                  </td>
                                                </tr>
                                  ...
                                  <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <button onclick="view(this)" type="button" class="light-card border-primary border b-r-10" value="' . $row["GenJourID"] . '"><i class="fa fa-eye txt-primary"></i></button>
                                        </td>
                                      </tr>
                                  ';
                                    }
