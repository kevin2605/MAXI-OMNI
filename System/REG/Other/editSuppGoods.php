                                    ...
                                    <form class="row g-3" action="../Process/editSupportingGoods.php" method="POST">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="namabarang" name="namabarang" type="text"
                                                value="<?php echo $goods["GoodsName"]; ?>"
                                                placeholder="Bapang Penunjang Produksi" required>
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="group" name="group" list="groupOptions"
                                                value="<?php echo $goods["GroupCD"]; ?>" placeholder="Group" required>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="keterangan1" name="keterangan1" type="text"
                                                value="<?php echo $goods["Desc_1"]; ?>" placeholder="...">
                                        </div>
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="buyprice" name="buyprice" type="text"
                                                value="<?php echo $goods["BuyPrice"]; ?>" placeholder="0" required>
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="keterangan2" name="keterangan2" type="text"
                                                value="<?php echo $goods["Desc_2"]; ?>" placeholder="...">
                                        </div>
                                        <div class="col-6"></div>
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="keterangan3" name="keterangan3" type="text"
                                                value="<?php echo $goods["Desc_3"]; ?>" placeholder="...">
                                        </div>
                                        <div class="col-6"></div>
                                        <hr>
                                        <div class="col-4">
