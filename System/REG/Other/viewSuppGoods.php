...
<head>
    ...
    <script>
        ...
        function editGoods(x) {
            document.location = "editSuppGoods.php?goodscd=" + x.value;
        }
    </script>
</head>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <?php
                                    $queryg = "SELECT * FROM supportinggoods WHERE GoodsCD='" . $_GET["goodscd"] . "'";
                                    $resultg = mysqli_query($conn, $queryg);
                                    $goods = mysqli_fetch_assoc($resultg);
                                    ?>
                                    <form class="row g-3" action="../Process/editSupportingGoods.php" method="POST">
                                        <div class="col-3">
                                            <label class="form-label" for="urutanreport">Urutan<span
                                                    style="color:red;">*</span></label>
                                            <input class="form-control" id="urutanreport" name="urutanreport"
                                                type="text" value="<?php echo $goods["Sequence"]; ?>" placeholder="1"
                                                readonly>
                                        </div>
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="kodebarang" name="kodebarang" type="text"
                                                value="<?php echo $goods["GoodsCD"]; ?>" placeholder="ABXXXX"
                                                aria-label="Kode Produk" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label" for="namabarang">Nama Barang<span
                                                    style="color:red;">*</span></label>
                                            <input class="form-control" id="namabarang" name="namabarang" type="text"
                                                value="<?php echo $goods["GoodsName"]; ?>" placeholder="barang contoh"
                                                readonly>
                                        </div>
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="satuanpertama" list="satuanOptions"
                                                name="satuan" value="<?php echo $goods["UnitCD"]; ?>"
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="group" name="group" list="groupOptions"
                                                value="<?php echo $goods["GroupCD"]; ?>" placeholder="Group" readonly>
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="kategori" name="kategori"
                                                list="kategoriOptions" value="<?php echo $goods["CategoryCD"]; ?>"
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input class="form-control" id="supplier" name="supplier"
                                                list="supplierOptions" value="<?php echo $goods["SupplierNum"]; ?>"
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="keterangan1" name="keterangan1" type="text"
                                                value="<?php echo $goods["Desc_1"]; ?>" placeholder="..." readonly>
                                        </div>
                                        <div class="col-3">
                                            <label class="form-label" for="buyprice">Harga Beli<span
                                                    style="color:red;">*</span><i>exclude</i></label>
                                            <input class="form-control" id="buyprice" name="buyprice" type="text"
                                                value="<?php echo $goods["BuyPrice"]; ?>" placeholder="0" readonly>
                                        </div>
                                        <div class="col-3">
                                            <input id="ppnCheck" type="checkbox" name="tax" value="1" <?php if ($goods["Tax"] == 1) {
                                                echo "checked";
                                            } ?> onclick="withPPN()" disabled>
                                            <label class="form-label" for="usetax">PPN</label>
                                            <input class="form-control" id="usetax" name="usetax" type="text" <?php if ($goods["Tax"] == 0) {
                                                echo 'value="-"';
                                            } else {
                                                echo 'value="' . $goods["BuyPrice"] * 1.11 . '"';
                                            } ?> readonly>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="keterangan2" name="keterangan2" type="text"
                                                value="<?php echo $goods["Desc_2"]; ?>" placeholder="..." readonly>
                                        </div>
                                        <div class="col-6"></div>
                                        <div class="col-6">
                                            ...
                                            <input class="form-control" id="keterangan3" name="keterangan3" type="text"
                                                value="<?php echo $goods["Desc_3"]; ?>" placeholder="..." readonly>
                                        </div>
                                        <div class="col-6"></div>
                                        <hr>
                                        <div class="col-4">
                                                ...
                                                <div class="radio-form">
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="flexRadioDefault3"
                                                            type="radio" name="Status" value="1" <?php if ($goods["Status"] == 1) {
                                                                echo "checked";
                                                            } ?> disabled>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="flexRadioDefault4"
                                                            type="radio" name="Status" value="0" <?php if ($goods["Status"] == 0) {
                                                                echo "checked";
                                                            } ?> disabled>
                                                        <label class="form-check-label"
                                        ...
                                        <hr>
                                        <div class="col-12">
                                            <a class="btn btn-warning" href="supporting-goods.php">Back</a>
                                            <button class="btn btn-info" type="button" onclick="editGoods(this)"
                                                value="<?php echo $_GET["goodscd"] ?>">Edit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
