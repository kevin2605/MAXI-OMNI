                              ...
                              <div class="modal-body dark-modal">
                                <div class="card-body custom-input">
                                  <form class="row g-3" action="../Process/createReception.php" method="POST"
                                    ...
                                    <div class="col-6">
                                      <label class="form-label" for="poid">Purchase Order<span style="color:red;">*</span></label>
                                      <input class="form-control" id="poid" name="poid" list="poOptions" placeholder="-- Pilih Purchase Order --" required>
                                    ...
                                    <div class="col-3">
                                      <label class="form-label" for="gudang">Gudang<span style="color:red;">*</span></label>
                                    ...
                                    <ul class="simple-wrapper nav nav-tabs" id="myTab" role="tablist">
                                      <li class="nav-item"><a class="nav-link active txt-primary" id="home-tab" data-bs-toggle="tab" href="#detail" role="tab" aria-controls="home" aria-selected="true">Detail</a></li>
                                      <li class="nav-item"><a class="nav-link txt-primary" id="dokumen-tabs" data-bs-toggle="tab" href="#dokumen" role="tab" aria-controls="dokumen" aria-selected="false">Dokumen</a></li>
                                      <li class="nav-item"><a class="nav-link txt-primary" id="profile-tabs" data-bs-toggle="tab" href="#photofiles" role="tab" aria-controls="profile" aria-selected="false">Foto</a></li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent">
                                      ...
                                      <div class="tab-pane fade show" id="photofiles" role="tabpanel" aria-labelledby="profile-tab">
                                        <div class="card">
                                          <div class="card-body">
                                            <label class="form-label" for="dokbarang">Dokumen Barang</label>
                                            <input class="form-control" id="dokbarang" name="dokbarang[]" type="file" multiple required>
                                ...
                                <tbody>
                                  ...
                                  while ($rowR = mysqli_fetch_array($resultR)) {
                                    echo '<tr>
                                          ...
                                          <ul> ';
                                    if ($can_update) {
                                      echo '<button onclick="viewReception(this)" value="' . $rowR["ReceptionID"] . '" type="button" class="light-card border-primary border b-r-10"><i class="fa fa-eye txt-primary"></i></button>';
                                    }
                                    echo '                                                             
                                          </ul>
                                          </td>
                                ...
                                <tbody>
                                  ...
                                  while ($rowR = mysqli_fetch_array($resultR)) {
                                    echo '<tr>
                                        ...
                                        <td> 
                                        <ul> 
                                          <button onclick="viewReception(this)" value="' . $rowR["ReceptionID"] . '" type="button" class="light-card border-primary border b-r-10"><i class="fa fa-eye txt-primary"></i></button>
                                        </ul>
                                        </td>
                                    </tr>';
                                  }
