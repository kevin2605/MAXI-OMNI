    ...
    <script>
        ...
        function approvePO(str) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location = "../Process/eventApprovePO.php?id=" + str.value + "&po=Material";
                }
            });
        }
        ...
        function rejectPO(str) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    document.location = "../Process/eventRejectPO.php?id=" + str.value + "&po=Material";
                }
            });
        }
                                        ...
                                        <div class="overflow-auto">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    FROM (purchaseorderdetail pod JOIN material m ON pod.ItemCD=m.MaterialCD) 
