...
logAction($conn, $creator, 'Create', 'membuat purchase order bahan baku', ($resulth == 1 && $resultd == 1 && $resultu == 1) ? 0 : 1, $poid);

if ($resulth == 1 && $resultd == 1) {
    header("Location:../Local-Purchasing/purchasing-material.php?status=success-po");
} else {
    header("Location:../Local-Purchasing/purchasing-material.php?status=error-po");
}
